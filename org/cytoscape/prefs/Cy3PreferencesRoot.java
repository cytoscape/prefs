...
public class Cy3PreferencesRoot extends PreferenceContainer implements ActionListener
{
	...
	static int NPREFS = 11;				// TODO -- hard-coded assumption of 3 x 5
...
//					System.out.println("adding: " + buttons[j].getText() + " -> " + components[j]);
			...
			contentsPanel.add(fPrefs[10], "Advamced");
	...
	private void initUI() {
			...
			fPrefs[3] = new PrefsStyles(this);

			fPrefs[4] = new PrefsBehavior(this);			// row 2
			fPrefs[5] = new PrefsEfficiency(this);
			fPrefs[6] = new PrefsSecurity(this);
	
			fPrefs[7] = new PrefsColors(this);		// row 3
			fPrefs[8] = new PrefsText(this);
			fPrefs[9] = new PrefsLinks(this);
						
			fPrefs[10] = new PrefsAdvanced(this);			// available thru Tabular button
