...
public enum ColorBrewer {
 ...
 Spectral (1, "Spectral colors", false, new int[][]{
  ...
  hsvCyMg (1, "HSV Cy-Mg", true, new int[][] {
	 ...
	 private boolean colorBlindSafe;

	 ColorBrewer(int paletteType, String paletteDescription, boolean colorBlindSafe, int[][] hexColors) {
	 ...
	 public static ColorBrewer[] getSequentialColorPalettes(boolean colorBlindSafe) {
		 return getPalettes(3, colorBlindSafe);
	 }
	 
	 public static ColorBrewer[] getDivergingColorPalettes(boolean colorBlindSafe) {
		 return getPalettes(1, colorBlindSafe);
	 }
	 
	 public static ColorBrewer[] getQualitativeColorPalettes(boolean colorBlindSafe) {
		 return getPalettes(2, colorBlindSafe);
	 }
	 
	 private static ColorBrewer[] getPalettes(int paletteType, boolean colorBlindSafe) {
		 List<ColorBrewer> palettes = new ArrayList<ColorBrewer>();
		 
		 if (colorBlindSafe) {
			 for (ColorBrewer palette: values()) {
				 if (palette.paletteType == paletteType && palette.colorBlindSafe) {
