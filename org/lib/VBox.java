...
public class VBox extends AntiAliasedPanel
{
	...
	public VBox(String str, Dimension size) 	{ this(str, true, false);		if (size != null) GuiFactory.setSizes(this, size); }
	public VBox(Dimension size) 				{ this(false);			if (size != null) GuiFactory.setSizes(this, size); }
	...
	public VBox(String title, boolean useGlue, boolean spacer, Component ... components)
		...
		for(Component comp : components)
		{
			...
			add(comp);
			if (useSpacer) add(Box.createRigidArea(BoxConstants.COMPONENT_SPACE));
